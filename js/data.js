...
window.KK_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      color: '#f7a841',
      colorRgb: '247,168,65',
      tag: 'Native macOS App · DSP Engine',
      sub: { de: 'DJ Mastering & Harmonic Mixing Workstation', en: 'DJ Mastering & Harmonic Mixing Workstation' },
      desc: {
        de: 'AI-gestützte Audio-Mastering & Harmonic-Mixing Workstation. React 19 / Vite UI mit Express API und Python DSP (librosa, ffmpeg) zur LUFS-Normalisierung und Camelot-Wheel Set Curation. Standalone Native macOS .app Launcher.',
        en: 'AI-assisted audio mastering & harmonic mixing workstation. React 19 / Vite UI with Express API and Python DSP (librosa, ffmpeg) for LUFS targeting and Camelot Wheel set curation. Standalone native macOS .app launcher.',
      },
      stack: ['React 19 / Vite 6', 'TypeScript', 'Express API', 'Python DSP (librosa/ffmpeg)', 'Google Gemini 1.5 Pro', 'Native macOS .app'],
